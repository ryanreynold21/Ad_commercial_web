...
const ProductSection = () => {
  const data = [
    ...
    },
    {
      ...
      price: "¥ 499",
      photo:
        "https://www.ftxk.cn/Uploads/Picture/single/1/2019/06/26/5d13262c0becd.jpg",
    },
  ];
  return (
    <div>
      <div className=" grid grid-cols-5 gap-5">
        ...
        <div className=" my-10 flex flex-col gap-10">
          <div className="relative overflow-hidden p-2 text-center z-[3] text-green-800 text-[20px] border border-dashed border-green-800">
            <span className="absolute top-0 left-0 rotate-[-50deg] translate-y-2 -translate-x-5 bg-red-600 text-white w-[100px]">
              hot
            </span>
          ...
          <ul className=" flex flex-col gap-10">
            {data.map((card) => (
              <li
                className=" flex gap-6 px-5 cursor-pointer hover:-translate-y-2 hover:shadow-lg transition-all duration-200"
                key={card.id}
              >
                <img
                  src={card.photo}
                ...
                <div className="">
                  ...
                  <p className=" text-red-600 text-[20px] font-[600]">
                    {card.price}
                  </p>
                </div>
              </li>
            ...
            {data.map((card, index) => (
              <div className=" flex justify-center items-center gap-5 cursor-pointer hover:translate-x-4 hover:shadow-xl transition-all duration-200">
                ...
                <div className=" flex flex-col gap-10">
                  ...
                  <p className=" text-[20px] text-red-600 font-[600]">
                    {card.price}
                  </p>
                </div>
              </div>
          ...
          <div className=" grid grid-rows-2">
            <div className=" w-full">
              <img
                ...
                src="https://www.ftxk.cn/Uploads/Picture/single/2/2019/06/26/5d132faedb690.jpg"
                alt=""
              />
              <h1 className=" text-[20px] font-[500] text-center text-black">
                Selebritee open crotch sex stockings
              </h1>
            </div>
            <div className=" w-full">
              <img
                className=" w-[350px] h-[350px] object-cover object-center"
                src="https://www.ftxk.cn/Uploads/Picture/single/2/2019/12/11/5df0528791227.jpg"
                alt=""
              />
              <h1 className=" text-[20px] font-[500] text-center text-black">
                Selebritee open crotch sex stockings
